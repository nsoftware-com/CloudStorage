object FormGoogledrive: TFormGoogledrive
  Left = 0
  Top = 0
  Anchors = [akLeft, akTop, akRight, akBottom]
  Caption = 'GoogleDrive Demo'
  ClientHeight = 550
  ClientWidth = 630
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Caption = 
      ...
      'nts from Google Drive. To begin click Authorize to allow the app' +
      'lication to access your account. The Authorization String is cre' +
  ...
  object csGoogleDrive1: TcsGoogleDrive
    SSLCertStore = 'MY'
    Left = 504
    Top = 157
  end
