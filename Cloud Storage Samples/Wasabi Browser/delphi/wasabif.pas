...
type
  TFormWasabi = class(TForm)
    ...
    procedure lvwBucketsSelectItem(Sender: TObject; Item: TListItem;
      Selected: Boolean);
    procedure icsWasabi1BucketList(Sender: TObject; const BucketName,
      CreationDate, OwnerId, OwnerName: String);
    procedure icsWasabi1ObjectList(Sender: TObject; const ObjectName,
...
procedure TFormWasabi.icsWasabi1BucketList(Sender: TObject; const BucketName,
  CreationDate, OwnerId, OwnerName: String);
begin
...
procedure TFormWasabi.icsWasabi1ObjectList(Sender: TObject; const ObjectName,
